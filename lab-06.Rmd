...
I think the plot above already shows that the proportion of part-time faculty have gone up over time compared to other instructional staff types, so there is no other changes we need to make.
